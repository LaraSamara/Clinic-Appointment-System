  ...
  return (
    <FormikProvider value={formik}>
      <Form className={classes.formGrid}>
        ...
        {formik.values.role === USER_ROLES.DOCTOR && (
          <ClinicTextField label="Specialty" name="specialty" />
        )}
        {formik.values.role === USER_ROLES.PATIENT && (
          <>
            <Button
              component="label"
            ...
            <ClinicTextField label="Illness Location" name="illnessLocation" />
          </>
        )}
        <FormControl
          component="fieldset"
          sx={{
            marginTop:
              formik.values.role === USER_ROLES.DOCTOR ? "-15px" : "0px",
          }}
        >
          <FormGroup
            row
